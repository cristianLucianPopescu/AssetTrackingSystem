...
//            string nistDatabase = client.DownloadString("");
//            dynamic dobj = JsonConvert.DeserializeObject<dynamic>(nistDatabase);
//            string show = dobj.ToString();

//        }

//        //public static void Search(string assetName)
//        //{
...
namespace TrackMe
{
    ...
    public class Cpe_Match
    {
        ...
        public object[] cpe_name { get; set; }
    }
